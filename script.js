...
loadMovies();
// Create a way for the Movies to be type in search bar and displayed on the screen by title
// Create a way for the Movie infromation and image to be displayed on the screen
// Create a way for type of a movie to be loaded
// Create a way for there to be a random search for 4 movies
